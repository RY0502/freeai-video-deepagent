...
## YouTube
${youtubeRule}
When an upload is requested, \`youtubeUpload\` is required in the locked plan. Write an engaging, truthful title; a useful description that discloses AI generation; 5-12 specific unique tags; and the most relevant category ID from: \`1\` Film & Animation, \`2\` Autos & Vehicles, \`10\` Music, \`15\` Pets & Animals, \`17\` Sports, \`19\` Travel & Events, \`20\` Gaming, \`22\` People & Blogs, \`23\` Comedy, \`24\` Entertainment, \`25\` News & Politics, \`26\` Howto & Style, \`27\` Education, \`28\` Science & Technology, or \`29\` Nonprofits & Activism. Preserve explicit user metadata instructions. Use the exact trusted runtime values for privacy and made-for-kids status; never choose more-public visibility than configured.
